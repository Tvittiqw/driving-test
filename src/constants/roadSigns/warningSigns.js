...
const WARNING_SIGNS = [
  ...
  },
  {
    ...
    label: "Uneaven Road",
    description:
      "Refers to a road surface that is not smooth and may have variations in elevation, bumps, or irregularities.",
    icon: unEvenRoad,
  },
  {
    type: "warning",
    label: "Two-Way Traffic Crossing Ahead",
    description:
      "Sign is a warning sign used to alert that two-way traffic crossing ahead",
    icon: twoWay,
  },
  {
    type: "warning",
    ...
    description:
      "This is a warning sign, used to rise awareness, vehicles should keep to the left hand side of the road and be alerted about oncoming traffic.",
    icon: twoWayStraignt,
  },
  {
    type: "warning",
  ...
  },
  {
    ...
    description:
      "Sign is a warning sign used to alert drivers that they are approaching a location where tram tracks cross the road.",
    icon: tramCrossing,
  },
  {
    type: "warning",
    ...
    description:
      "Sign is a warning sign used to inform drivers that there are traffic signals (traffic lights) ahead on the road.",
    icon: traficSignals,
  },
  {
    type: "warning",
    ...
    description:
      "Sign is a warning sign used to alert drivers that there is a high probability of encountering a line or queue of vehicles ahead, which may result in slowed or stopped traffic.",
    icon: traficQueues,
  },
  {
    type: "warning",
    label: "Steep Descent",
    description:
      "sign is a warning sign used to alert drivers that they are approaching a steep downhill incline.",
    icon: steepDescent,
  },
  {
    type: "warning",
    label: "Steep Ascent",
    description:
      "Sign is a warning sign used to alert drivers that they are approaching a steep uphill incline.",
    icon: steepAscent,
  },
  {
    type: "warning",
    label: "Soft Verges",
    description:
      "Sign refers to the soft or less firm areas at the edges of the road, commonly covered with grass, soil, or other vegetation.",
    icon: softVerges,
  },
  {
    type: "warning",
    label: "Snow or ice",
    description:
      "Sign is used to alert drivers that they may encounter slippery road conditions due to snow or ice.",
    icon: snow,
  },
  {
    type: "warning",
    ...
    description:
      "Sign is a warning sign used to indicate that the slow moving heavy vehicle ahead ahead.",
  ...
  },
  {
    ...
    label: "Slippery Road",
    description:
      "Sign is a warning sign used to indicate that the slippery road ahead.",
    icon: slipperyRoad,
  },
  {
    type: "warning",
    ...
    description:
      "sign is a warning sign used to indicate that the school crossing ahead.",
    icon: schoolCrossing,
  },
  {
    type: "warning",
    ...
    description:
      "sign is a warning sign used to indicate that the road hump ahead.",
    icon: roadHumpAhead,
  },
  {
    type: "warning",
    ...
    description:
      "sign is a warning sign used to indicate that the roundabout ahead.",
  ...
  },
  {
    ...
    description:
      "sign is a warning sign used to indicate that the roadworks ahead.",
    icon: roadworksAhead,
  },
  {
    type: "warning",
    ...
    description:
      "sign is a warning sign used to indicate that the road ahead will become narrower on both sides.",
  ...
  },
  {
    ...
    description:
      "sign is a warning sign used to indicate that the road ahead will become narrower on one side.",
  ...
  },
  {
    ...
    description:
      "Sign is a warning sign used to alert drivers that pedestrians are frequently in the road.",
  ...
  },
  {
    ...
    description:
      "Sign is a warning sign used to alert drivers that there is a pedestrian crossing or crosswalk up ahead.",
  ...
  },
  {
    ...
    description:
      "Sign warns drivers that there are high-voltage electric cables above the road.",
  ...
  },
  {
    ...
    label: "Other danger",
    description:
      "Its use is usually temporary, to alert of a new hazard in the road, however where it is difficult to sign for a permanent hazard such as a Hidden Dip it is permitted for permanent use until the hazard is removed.",
    icon: otherDanger,
  },
  {
    type: "warning",
  ...
  },
  {
    ...
    label: "Bend ahead",
    description:
      "This sign is meant to alert drivers to reduce their speed and be prepared for changes in the direction of the road.",
    icon: bendAhead,
  },
  {
    type: "warning",
    label: "Bridge ahead",
    description:
      "indicating that there is a bridge structure ahead on the road",
    icon: bridge,
  },
  {
    type: "warning",
    label: "Children",
    description:
      'The "Children" crossing sign tells drivers that kids might be crossing the road, so they need to be careful and watch out for them.',
    icon: children,
  },
  {
    type: "warning",
    ...
    description:
      "Sign indicates an upcoming intersection where a smaller road joins a major road",
    icon: crossMinor,
  },
  {
    type: "warning",
    ...
    description:
      "Sign indicates an upcoming intersection where vehicles approaching from the right have the right of way",
  ...
  },
  {
    ...
    description:
      "Sign warns drivers that strong and unpredictable horizontal winds may affect their vehicles",
    icon: crosswinds,
  },
  {
    type: "warning",
    ...
    description:
      "Sign warns drivers that there may be animals, such as livestock or pets, on or near the road",
  ...
  },
  {
    ...
    description:
      "Sign alerts drivers to the presence of two consecutive bends or curves in the road ahead",
    icon: doubleBend,
  },
  {
    type: "warning",
    ...
    description:
      "sign informs drivers that the divided highway or dual carriageway is coming to an end",
  ...
  },
  {
    ...
    label: "Falling Rocks",
    description:
      "Sign warns drivers of the possibility of rocks or debris falling onto the road from the surrounding hills or cliffs",
    icon: fallingRocks,
  },
  {
    type: "warning",
  ...
  },
  {
    ...
    description:
      "sign warns drivers that there are intersections or junctions on the upcoming bend in the road",
    icon: junctionOnBend,
  },
  {
    type: "warning",
    ...
    description:
      "Sign alerts drivers that there is a railway level crossing up ahead equipped with barriers",
  ...
  },
  {
    ...
    description:
      "Sign alerts drivers that there is a railway level crossing up wthout barriers ahead",
    icon: levelCrossingNoBarriers,
  },
  {
    type: "warning",
    label: "Level crossing without  bariers",
    description:
      "Sign alerts drivers that there is a railway without  bariers up ahead",
    icon: levelCrossing,
  },
  {
    type: "warning",
  ...
  },
  {
    ...
    description:
      "Sign alerts drivers that there is a Low Flying Aircraft ahead",
  ...
  },
  {
    ...
    description:
      "Sign alerts drivers that there is a low Flying Helicopter ahead",
  ...
  },
  {
    ...
    description:
      "Sign is a warning sign that indicates that two separate streams of traffic are about to converge into a single lane or roadway.",
    icon: mergingTraffic,
  },
];
